<?php
	...
	<body id="productspage" class="product-page-titan ov-x-h">
		...
		<main class="ov-x-h">
			<section id="productos-slider" class="productos-slider-v2 bg-white pt-4 pb-4">
				<div class="container">
					<div class="box">
						<div class="box-img">
							<picture>
							  	<source srcset="<?php echo URL ?>img/productos/titan/banner.webp" type="image/webp">
							  	<source srcset="<?php echo URL ?>img/productos/titan/banner.png" type="image/png">
							  	<img
							  		src="<?php echo URL ?>img/productos/titan/banner.png"
							  		data-src="<?php echo URL ?>img/productos/titan/banner.png"
						...
						<div class="box-content mt-4">
							<p class="c-negro f-bold text-justify mb-3">
								Titán® cuenta con el alimento ideal para tu perro y gato, formulados con los nutrientes necesarios para mantener a tu mascota sana de adentro hacia afuera.
							</p>
							<p class="c-negro f-bold text-justify mb-3">
								Por la selección de sus ingredientes, Titán® es el alimento con calidad Premium que no te cuesta más.
							</p>
							<p class="c-negro f-bold text-justify">
								¡Mascota sana cuesta menos!
							</p>
						</div>
					</div>
				</div>
			...
			<section id="productos-card" class="productos-card-v2">
				<div class="row row-cols-1 row-cols-md-2 g-0 animatedParent" data-sequence="800">
					<div class="col p-0 animated fadeIn" data-id="1">
					    <div class="card h-100 bg-verde-4 pt-0 p-relative">
							<div class="card-image">
								<img src="<?php echo URL ?>img/productos/titan/perro/logo.png" width="201" height="100" class="card-img-top m-0-a" alt="">
							</div>
						    <div class="card-body">
						    	<picture>
								  	<source srcset="<?php echo URL ?>img/productos/titan/perro/render_bolsa_adulto_TT_perro.webp" type="image/webp">
								  	<source srcset="<?php echo URL ?>img/productos/titan/perro/render_bolsa_adulto_TT_perro.png" type="image/png">
								  	<img
								  		src="<?php echo URL ?>img/productos/titan/perro/render_bolsa_adulto_TT_perro.png"
								  		data-src="<?php echo URL ?>img/productos/titan/perro/render_bolsa_adulto_TT_perro.png"
						      	...
						      	<p class="card-text c-blanco f-medium text-justify mb-0">
						      		Titán® está formulado para favorecer la absorción de nutrientes de manera efectiva, fortaleciendo su sistema contra enfermedades intestinales.
						      	</p>
						      	<div class="card-content mt-4">
						      		<div class="d-flex justify-content-center mb-3">
						      			<div class="card-icon">
						      				<i class="fas fa-cat fa-fw fa-3x c-blanco me-2"></i>
	 					      			</div>
					...
					<div class="col p-0 animated fadeIn" data-id="2">
					    <div class="card h-100 bg-morado-1 pt-0 p-relative">
					    	<div class="card-image">
								<img src="<?php echo URL ?>img/productos/titan/gato/logo.png" width="201" height="100" class="card-img-top m-0-a" alt="">
							</div>
						    <div class="card-body">
						    	<picture>
								  	<source srcset="<?php echo URL ?>img/productos/titan/gato/render_bolsa_adulto_TT_gato.webp" type="image/webp">
								  	<source srcset="<?php echo URL ?>img/productos/titan/gato/render_bolsa_adulto_TT_gato.png" type="image/png">
								  	<img
								  		src="<?php echo URL ?>img/productos/titan/gato/render_bolsa_adulto_TT_gato.png"
								  		data-src="<?php echo URL ?>img/productos/titan/gato/render_bolsa_adulto_TT_gato.png"
								  		class="lazyload img-fluid m-0-a mt-3"
								  		width="313"
								  		height="400"
						      	...
						      	<p class="card-text c-blanco f-medium text-justify mb-0">
						      		Titán® Gato está formulado para favorecer la absorción de nutrientes de manera efectiva, fortaleciendo su sistema contra enfermedades intestinales.
						      	</p>
						      	<div class="card-content mt-4">
						      		<div class="d-flex justify-content-center mb-3">
						      			<div class="card-icon">
			...
			<section id="productos-beneficios" class="bg-white">
				<div id="top-productos-beneficios">
					<div class="container">
						<ul class="nav nav-tabs nav-tabs-v1 verde-4 justify-content-center animatedParent" data-sequence="1000" id="myTab" role="tablist">
							<li class="nav-item animated growIn" data-id="1" role="presentation">
							    <button class="nav-link c-verde-4 h-c-morado-1 active" id="perro-tab" data-bs-toggle="tab" data-bs-target="#perro" type="button" role="tab" aria-controls="perro" aria-selected="true">PERRO</button>
							</li>
							<li class="nav-item animated growIn" data-id="2" role="presentation">
							    <button class="nav-link c-morado-1 h-c-verde-4" id="gato-tab" data-bs-toggle="tab" data-bs-target="#gato" type="button" role="tab" aria-controls="gato" aria-selected="false">GATO</button>
							</li>
						</ul>
						<div class="tab-content tab-content-v1 mt-5" id="tabBeneficios">
							<!-- PERRO -->
							<?php require_once ('views/productos/titan/perro.php'); ?>
						  	<!-- GATO -->
						  	<?php require_once ('views/productos/titan/gato.php'); ?>
						</div>
					</div>
				</div>
			</section>
