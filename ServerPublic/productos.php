<?php
	...
	<body id="productspage" class="product-page-smart-bites ov-x-h">
		...
		<main class="ov-x-h">
						...
						<div class="box block-2">
							<div class="box-img">
								<picture id="img-parallax-1" class="position-absolute">
								  	<source srcset="<?php echo URL ?>img/productos/smart-bites/smart-bites-neuro-active-senior.webp" type="image/webp">
								  	<source srcset="<?php echo URL ?>img/productos/smart-bites/smart-bites-neuro-active-senior.png" type="image/png">
								  	<img
								  		src="<?php echo URL ?>img/productos/smart-bites/smart-bites-neuro-active-senior.png"
								  		data-src="<?php echo URL ?>img/productos/smart-bites/smart-bites-neuro-active-senior.png"
								...
								<picture id="img-parallax-2" class="position-absolute">
								  	<source srcset="<?php echo URL ?>img/productos/smart-bites/inicio_smart_perro.webp" type="image/webp">
								  	<source srcset="<?php echo URL ?>img/productos/smart-bites/inicio_smart_perro.png" type="image/png">
								  	<img
								  		src="<?php echo URL ?>img/productos/smart-bites/inicio_smart_perro.png"
								  		data-src="<?php echo URL ?>img/productos/smart-bites/inicio_smart_perro.png"
								...
								<picture id="img-parallax-3" class="position-absolute">
								  	<source srcset="<?php echo URL ?>img/productos/smart-bites/smart-bites-neuro-active-adulto.webp" type="image/webp">
								  	<source srcset="<?php echo URL ?>img/productos/smart-bites/smart-bites-neuro-active-adulto.png" type="image/png">
								  	<img
								  		src="<?php echo URL ?>img/productos/smart-bites/smart-bites-neuro-active-adulto.png"
								  		data-src="<?php echo URL ?>img/productos/smart-bites/smart-bites-neuro-active-adulto.png"
								...
								<picture id="img-parallax-4" class="position-absolute">
								  	<source srcset="<?php echo URL ?>img/productos/smart-bites/smart-bites-neuro-active-cachorro.webp" type="image/webp">
								  	<source srcset="<?php echo URL ?>img/productos/smart-bites/smart-bites-neuro-active-cachorro.png" type="image/png">
								  	<img
								  		src="<?php echo URL ?>img/productos/smart-bites/smart-bites-neuro-active-cachorro.png"
								  		data-src="<?php echo URL ?>img/productos/smart-bites/smart-bites-neuro-active-cachorro.png"
								  		class="lazyload animated fadeInDownShort slowest"
								  		data-id="3"
								  		width="242"
								  		height="380"
			...
			<section id="productos-card" class="productos-card-v1 position-relative">
				<div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-0 justify-content-center animatedParent" data-sequence="800">
					<div id="card-1" class="col p-0 position-relative animated fadeIn" data-id="1">
					    <div class="card h-100 bg-verde-3">
						    ...
						    <div class="card-body position-relative">
						    	<picture>
								  	<source srcset="<?php echo URL ?>img/productos/smart-bites/render_bolsa_cachorro_SB.webp" type="image/webp">
								  	<source srcset="<?php echo URL ?>img/productos/smart-bites/render_bolsa_cachorro_SB.png" type="image/png">
								  	<img
								  		src="<?php echo URL ?>img/productos/smart-bites/render_bolsa_cachorro_SB.png"
								  		data-src="<?php echo URL ?>img/productos/smart-bites/render_bolsa_cachorro_SB.png"
						      	...
						      	<div class="card-content mt-4">
						      		<div class="row g-3 g-md-2 g-xl-0 justify-content-center mb-3">
						      			...
						      			<div class="card-description col-10 col-sm-5 col-md-8 col-xl-7 col-xxl-8">
						      				...
						      				<p class="c-blanco f-medium fs-6">Hasta 18 meses</p>
						      			</div>
						      		</div>
						      		<div class="row g-3 g-md-2 g-xl-0 justify-content-center mb-3">
						      			<div class="card-icon col-2 col-md-3 text-center">
						      			...
						      			<div class="card-description col-10 col-sm-5 col-md-8 col-xl-7 col-xxl-6">
						      				...
						      				<p class="c-blanco f-medium fs-6">2, 4, 10 y 20 kg</p>
						      			</div>
					...
					<div id="card-2" class="col p-0 position-relative animated fadeIn" data-id="2">
					    <div class="card h-100 bg-amarillo-1">
						    ...
						    <div class="card-body position-relative">
						    	<picture>
								  	<source srcset="<?php echo URL ?>img/productos/smart-bites/render_bolsa_adulto_SB.webp" type="image/webp">
								  	<source srcset="<?php echo URL ?>img/productos/smart-bites/render_bolsa_adulto_SB.png" type="image/png">
								  	<img
								  		src="<?php echo URL ?>img/productos/smart-bites/render_bolsa_adulto_SB.png"
								  		data-src="<?php echo URL ?>img/productos/smart-bites/render_bolsa_adulto_SB.png"
								...
								<img
						      	...
						      	<div class="card-content mt-4">
						      		<div class="row g-3 g-md-2 g-xl-0 justify-content-center mb-3">
						      			...
						      			<div class="card-description col-10 col-sm-5 col-md-8 col-xl-7 col-xxl-8">
						      				<h5 class="c-blanco f-black mb-0 fs-6">Edad</h5>
						      				<p class="c-blanco f-medium fs-6">18 meses a 7 años</p>
						      			</div>
						      		</div>
						      		<div class="row g-3 g-md-2 g-xl-0 justify-content-center mb-3">
						      			<div class="card-icon col-2 col-md-3 text-center">
						      			...
						      			<div class="card-description col-10 col-sm-5 col-md-8 col-xl-7 col-xxl-6">
						      				<h5 class="c-blanco f-black mb-0 fs-6">Presentaciones</h5>
						      				<p class="c-blanco f-medium fs-6">2, 4, 15 y 25 kg</p>
						      			</div>
						      			<div class="card-link col-12 col-xxl-2 text-center text-xxl-end">
						      				<a rel="noopener" class="d-block c-rojo-1 h-c-rojo-6" href="<?php echo URL; ?>cerca-de-ti/comprar-en-linea" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Compra">
								                <span class="fa-stack fa-xl">
					...
					<div id="card-3" class="col p-0 position-relative animated fadeIn" data-id="3">
					    <div class="card h-100 bg-azul-17">
						    ...
						    <div class="card-body position-relative">
						    	<picture>
								  	<source srcset="<?php echo URL ?>img/productos/smart-bites/render_bolsa_senior_SB.webp" type="image/webp">
								  	<source srcset="<?php echo URL ?>img/productos/smart-bites/render_bolsa_senior_SB.png" type="image/png">
								  	<img
								  		src="<?php echo URL ?>img/productos/smart-bites/render_bolsa_senior_SB.png"
								  		data-src="<?php echo URL ?>img/productos/smart-bites/render_bolsa_senior_SB.png"
								  		class="lazyload img-fluid mx-auto d-block mt-3"
								  		width="477"
								  		height="400"
								...
								<img
						      	...
						      	<div class="card-content mt-4">
						      		<div class="row g-3 g-md-2 g-xl-0 justify-content-center mb-3">
						      			...
						      			<div class="card-description col-10 col-sm-5 col-md-8 col-xl-7 col-xxl-8">
						      				<h5 class="c-blanco f-black mb-0 fs-6">Edad</h5>
						      				<p class="c-blanco f-medium fs-6">7 años en adelante</p>
						      			</div>
						      		</div>
						      		<div class="row g-3 g-md-2 g-xl-0 justify-content-center mb-3">
						      			<div class="card-icon col-2 col-md-3 text-center">
						      			...
						      			<div class="card-description col-10 col-sm-5 col-md-8 col-xl-7 col-xxl-6">
						      				<h5 class="c-blanco f-black mb-0 fs-6">Presentaciones</h5>
						      				<p class="c-blanco f-medium fs-6">4 y 7 kg</p>
						      			</div>
						      			<div class="card-link col-12 col-xxl-2 text-center text-xxl-end">
						      				<a rel="noopener" class="d-block c-rojo-1 h-c-rojo-6" href="<?php echo URL; ?>cerca-de-ti/comprar-en-linea" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Compra">
								                <span class="fa-stack fa-xl">
