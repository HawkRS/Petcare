...
function MainFunction() {
  ...
  switch (bodyId) {
    case "Dashboard":
      {
        var dashboard = __webpack_require__(/*! ./landing.js */ "./resources/js/landing.js");
        dashboard();
        break;
      }
    case "Encuentranos":
      {
        ...
        var finduspage = __webpack_require__(/*! ./markers.js */ "./resources/js/markers.js");
        finduspage();
        break;
      }
    case "Blog":
      {
        //console.log('marcadores');
        var blogpage = __webpack_require__(/*! ./blog.js */ "./resources/js/blog.js");
        blogpage();
        break;
      }
    case "Blogedit":
      {
        //console.log('tinymce');
        var blogeditpage = __webpack_require__(/*! ./blogedit.js */ "./resources/js/blogedit.js");
        blogeditpage();
        break;
      }
    default:
  ...
  tinymce.init({
    ...
    setup: function setup(editor) {
      editor.on('init change', function () {
        ...
        editor.dom.setAttribs(editor.dom.select('img'), {
...
__webpack_require__(/*! C:\xampp7\htdocs\Petcare\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp7\htdocs\Petcare\resources\sass\app.sass */"./resources/sass/app.sass");
