  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-12 col-md-3">
        <div class="card">
          <div class="card-header card-primary">
            <h5 class="text-light">Imagen izq externa</h5>
          </div>
          <div class="card-body">
      ...
      <div class="col-12 col-md-3">
        <div class="card">
          <div class="card-header card-primary">
            <h5 class="text-light">Imagen izq interna</h5>
          </div>
          <div class="card-body">
      ...
      <div class="col-12 col-md-3">
        <div class="card">
          <div class="card-header card-primary">
            <h5 class="text-light">Imagen der interna</h5>
          </div>
          <div class="card-body">
      ...
      <div class="col-12 col-md-3">
        <div class="card">
          <div class="card-header card-primary">
            <h5 class="text-light">Imagen der externa</h5>
          </div>
          <div class="card-body">
    ...
    <div class="row justify-content-center">
      <div class="col-12 col-md-6 col-xl-5">
        <div class="card">
          <div class="card-header card-primary">
            <h5 class="text-light">Texto banner</h5>
          </div>
          <div class="card-body">
            <h4>Parrafo 1</h4>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="ImgIzqExtModalLabel">Imagen Izquierda Externa (450px X 450px)</h1>
...
{{-- Imagen IZQ Interna --}}
  <div class="modal fade" id="ImgIzqIntModal" tabindex="-1" aria-labelledby="ImgIzqIntModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="ImgIzqIntModalLabel">Imagen Izquierda Externa (450px X 450px)</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form class="needs-validation" action="{{ route('smartbites.updatecontent') }}" method="post" enctype="multipart/form-data"  novalidate>
          @csrf
...
{{-- Imagen DER Interna --}}
  <div class="modal fade" id="ImgDerIntModal" tabindex="-1" aria-labelledby="ImgDerIntModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="ImgDerIntModalLabel">Imagen Derecha interna (450px X 450px)</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form class="needs-validation" action="{{ route('smartbites.updatecontent') }}" method="post" enctype="multipart/form-data"  novalidate>
          @csrf
...
{{-- Imagen DER Externa --}}
  <div class="modal fade" id="ImgDerExtModal" tabindex="-1" aria-labelledby="ImgDerExtModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="ImgDerExtModalLabel">Imagen Derecha interna (450px X 450px)</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form class="needs-validation" action="{{ route('smartbites.updatecontent') }}" method="post" enctype="multipart/form-data"  novalidate>
          @csrf
