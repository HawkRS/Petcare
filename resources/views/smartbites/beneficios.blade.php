      ...
      <form class="needs-validation" action="{{ route('smartbites.updatebeneficios', ['section' => 'adulto']) }}" method="post" enctype="multipart/form-data"  novalidate>
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="beneficiostitulo" class="form-control {{ $errors->has('beneficiostitulo') ? ' is-invalid' : '' }}" id="beneficiostitulo" placeholder="Título" value="{{$Contenidos[16]->value}}" required>
            @else
            <input type="text" name="beneficiostitulo" class="form-control {{ $errors->has('beneficiostitulo') ? ' is-invalid' : '' }}" id="beneficiostitulo" placeholder="Título" required>
            @endif
            <div class="valid-feedback">
      ...
      <form class="needs-validation" action="{{ route('smartbites.updatebeneficios', ['section' => 'adulto']) }}" method="post" enctype="multipart/form-data"  novalidate>
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="beneficiostitulo" class="form-control {{ $errors->has('beneficiostitulo') ? ' is-invalid' : '' }}" id="beneficiostitulo" placeholder="Título" value="{{$Contenidos[18]->value}}" required>
            @else
            <input type="text" name="beneficiostitulo" class="form-control {{ $errors->has('beneficiostitulo') ? ' is-invalid' : '' }}" id="beneficiostitulo" placeholder="Título" required>
            @endif
            <div class="valid-feedback">
      ...
      <form class="needs-validation" action="{{ route('smartbites.updatebeneficios', ['section' => 'adulto']) }}" method="post" enctype="multipart/form-data"  novalidate>
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="beneficiostitulo" class="form-control {{ $errors->has('beneficiostitulo') ? ' is-invalid' : '' }}" id="beneficiostitulo" placeholder="Título" value="{{$Contenidos[20]->value}}" required>
            @else
            <input type="text" name="beneficiostitulo" class="form-control {{ $errors->has('beneficiostitulo') ? ' is-invalid' : '' }}" id="beneficiostitulo" placeholder="Título" required>
            @endif
            <div class="valid-feedback">
      ...
      <form class="needs-validation" action="{{ route('smartbites.updatebeneficios', ['section' => 'adulto']) }}" method="post" enctype="multipart/form-data"  novalidate>
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="beneficiostitulo" class="form-control {{ $errors->has('beneficiostitulo') ? ' is-invalid' : '' }}" id="beneficiostitulo" placeholder="Título" value="{{$Contenidos[22]->value}}" required>
            @else
            <input type="text" name="beneficiostitulo" class="form-control {{ $errors->has('beneficiostitulo') ? ' is-invalid' : '' }}" id="beneficiostitulo" placeholder="Título" required>
            @endif
            <div class="valid-feedback">
      ...
      <form class="needs-validation" action="{{ route('smartbites.updatebeneficios', ['section' => 'senior']) }}" method="post" enctype="multipart/form-data"  novalidate>
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="beneficiostitulo" class="form-control {{ $errors->has('beneficiostitulo') ? ' is-invalid' : '' }}" id="beneficiostitulo" placeholder="Título" value="{{$Contenidos[24]->value}}" required>
            @else
            <input type="text" name="beneficiostitulo" class="form-control {{ $errors->has('beneficiostitulo') ? ' is-invalid' : '' }}" id="beneficiostitulo" placeholder="Título" required>
            @endif
            <div class="valid-feedback">
      ...
      <form class="needs-validation" action="{{ route('smartbites.updatebeneficios', ['section' => 'senior']) }}" method="post" enctype="multipart/form-data"  novalidate>
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="beneficiostitulo" class="form-control {{ $errors->has('beneficiostitulo') ? ' is-invalid' : '' }}" id="beneficiostitulo" placeholder="Título" value="{{$Contenidos[26]->value}}" required>
            @else
            <input type="text" name="beneficiostitulo" class="form-control {{ $errors->has('beneficiostitulo') ? ' is-invalid' : '' }}" id="beneficiostitulo" placeholder="Título" required>
            @endif
            <div class="valid-feedback">
      ...
      <form class="needs-validation" action="{{ route('smartbites.updatebeneficios', ['section' => 'senior']) }}" method="post" enctype="multipart/form-data"  novalidate>
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="beneficiostitulo" class="form-control {{ $errors->has('beneficiostitulo') ? ' is-invalid' : '' }}" id="beneficiostitulo" placeholder="Título" value="{{$Contenidos[28]->value}}" required>
            @else
            <input type="text" name="beneficiostitulo" class="form-control {{ $errors->has('beneficiostitulo') ? ' is-invalid' : '' }}" id="beneficiostitulo" placeholder="Título" required>
            @endif
            <div class="valid-feedback">
      ...
      <form class="needs-validation" action="{{ route('smartbites.updatebeneficios', ['section' => 'senior']) }}" method="post" enctype="multipart/form-data"  novalidate>
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="beneficiostitulo" class="form-control {{ $errors->has('beneficiostitulo') ? ' is-invalid' : '' }}" id="beneficiostitulo" placeholder="Título" value="{{$Contenidos[30]->value}}" required>
            @else
            <input type="text" name="beneficiostitulo" class="form-control {{ $errors->has('beneficiostitulo') ? ' is-invalid' : '' }}" id="beneficiostitulo" placeholder="Título" required>
            @endif
            <div class="valid-feedback">
