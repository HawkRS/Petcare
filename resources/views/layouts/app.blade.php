...
<html lang="es_MX" dir="ltr">
    <head>
      ...
      <meta name="description" content="Sistema administrador Vimifos Petcare">
      <meta name="author" content="Hawk Media">
            ...
            <div class="navbar-header">
              <div class="d-flex">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                  <!-- item-->
                  <a class="dropdown-item" href="{{ route('users.index') }}"><i class="ri-user-line align-middle me-1"></i> Usuarios</a>
